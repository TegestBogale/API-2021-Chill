package ch.heigvd.res.chill.domain.vkaelin;

import ch.heigvd.res.chill.domain.Bartender;
import ch.heigvd.res.chill.domain.vkaelin.Wittekop;
...
public class WittekopTest {
    ...
    void aBartenderShouldAcceptAnOrderForWittekop() {
        ...
        String productName = "ch.heigvd.res.chill.domain.vkaelin.Wittekop";
